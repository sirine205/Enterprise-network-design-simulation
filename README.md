...
TechCorp operates two sites — HQ and Branch — each with three departments: IT, HR, and Sales. The network enforces department isolation via VLANs, routes between sites using multi-area OSPF, and will control cross-department access via firewall ACLs.
